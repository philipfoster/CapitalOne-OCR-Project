...
public interface DocumentDao {
    ...
    /**
     * This method will insert a document into the database. The {@link Document#getId()} field will also be
     ...
     * @param pageSize The maximum number of elements to retrieve
     * @param pageNum The page offset, starting at 0.
     * @return The set of matching documents sorted by relevance in descending order
     */
    List<Document> getDocumentsByKeyword(String keyword, int pageSize, int pageNum);
}
